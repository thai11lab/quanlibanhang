                        ...
                        <div class="product__details__slider__content">
                            <div class="product__details__pic__slider owl-carousel">
                                ...
                                <img data-hash="product-1" class="product__big__img"
                                    src="<c:url value='${product.mainImageUrl}'/>" alt="">
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__button">
                            ...
                            <a href="#" class="cart-btn" onclick="addToCart(${product.id})"><span class="icon_bag_alt"></span> Add to cart</a>
                            <ul>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg"
                                data-setbg='<c:url value="${itemProductCategory.mainImageUrl}"/>'>

                                <ul class="product__hover">
                                    <li><a href="" class="image-popup"><span class="arrow_expand"></span></a></li>
                                    <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                    <li onclick="addToCart(${itemProductCategory.id})"><a><span class="icon_bag_alt"></span></a></li>
                                </ul>
                            </div>
                            <div class="product__item__text">
                                <h6><a href="${urlProducts}/${itemProductCategory.id}">${itemProductCategory.name}</a>
                                </h6>
