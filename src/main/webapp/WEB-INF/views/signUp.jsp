				...
				<form id="formSignUp" method="post">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="userName" name="userName"
							placeholder="Tên đăng nhập" style="height: 35px;">
						<span style="display: flex;justify-content: flex-start;font-size: 13px;color: red"
							id="validate-username"></span>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="password" class="form-control" id="password" name="password" placeholder="Mật khẩu"
							style="height: 35px;">
						<span style="display: flex;justify-content: flex-start;font-size: 13px;color: red"
							id="validate-password"></span>
					</div>

					<div class="form-group">
						<label for="username" style="float: left;font-size: 15px">Nhập lại mật khẩu</label>
						<input type="password" class="form-control" id="passwordRe" placeholder="Nhập lại mật khẩu"
							style="height: 35px;">
						<span style="display: flex;justify-content: flex-start;font-size: 13px;color: red"
							id="validate-passwordRe"></span>
					</div>
	...
	<script type="text/javascript">
		...
		function signUpApi(data) {
			$.ajax({
				...
				url: "http://localhost:8080/webbanhang/api/signUp",
